    ...
    for k, v in pairs( r.synergies ) do
        ...
        for idx = 1, #v.types do
            ...
            syn[#syn + 1] = {
                ...
                getFunc  = function() return r.savedVars.synids[type].blocked end,
                setFunc  = function(val) r.savedVars.synids[type].blocked = val end,
                disabled = function() return not (r.savedVars.stamBlock or r.savedVars.magBlock) end,
        ...
        [2] = {
            ...
            controls = {
                ...
                },
                {
                    ...
                    setFunc = function (var) r.savedVars.enabled = var end,
                ...
                },
                {
                    type = "checkbox",
                    name = "Disable in PvP",
                    getFunc = function () return r.savedVars.blockInPvP end,
                    setFunc = function (var) r.savedVars.blockInPvP = var end,
                ...
                },
                {
                    type = "checkbox",
                    name = "Track Magicka",
                    getFunc = function () return r.savedVars.magBlock end,
                    setFunc = function (var) r.savedVars.magBlock = var end,
                ...
                },
                {
                    ...
                    getFunc = function () return r.savedVars.magThreshold end,
                    setFunc = function (val) r.savedVars.magThreshold = val end,
                    min = 0,
                    max = 100,
                    step = 10,
                    default = r.defaults["magThreshold"],
                    disabled = function () return not r.savedVars.magBlock end, 
                    width = "half",
                },
                {
                    type = "checkbox",
                    name = "Track Stamina",
                    getFunc = function () return r.savedVars.stamBlock end,
                    setFunc = function (var) r.savedVars.stamBlock = var end,
                ...
                },
                {
                    ...
                    getFunc = function () return r.savedVars.stamThreshold end,
                    setFunc = function (val) r.savedVars.stamThreshold = val end,
                    min = 0,
                    max = 100,
                    step = 10,
                    default = r.defaults["stamThreshold"],
                    disabled = function () return not r.savedVars.stamBlock end, 
                    width = "half",
                },
            },
        },
