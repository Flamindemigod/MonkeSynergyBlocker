...
r.synergies = {
    ...
    [TYPE_URSUS] = {
        id = "TYPE_URSUS",
        name = "Set Haven of Ursus",
        types = {[1] = 111437}
    },
    -- undaunted
    [TYPE_ALTAR] = {
        id = "TYPE_ALTAR",
        name = "Undaunted Blood Altar",
        types = {[1] = 39500, [2] = 41963}
    },
    [TYPE_SPIDER] = {
        id = "TYPE_SPIDER",
        name = "Undaunted Trapping Webs",
        types = {[1] = 39429, [2] = 41994, [3] = 42020}
    },
    [TYPE_TAUNT] = {
        id = "TYPE_TAUNT",
        name = "Undaunted Inner Fire",
        types = {[1] = 41839}
    },
    [TYPE_SHIELD] = {
        id = "TYPE_SHIELD",
        name = "Undaunted Bone Shield",
        types = {[1] = 39377, [2] = 42194}
    },
    [TYPE_ORB] = {
        id = "TYPE_ORB",
        name = "Undaunted Necrotic Orb",
        types = {[1] = 39301, [2] = 63507}
    },
    -- dragonknight
    [TYPE_STANDARD] = {
        id = "TYPE_STANDARD",
    ...
    [TYPE_TALONS] = {
        id = "TYPE_TALONS",
        name = "Dragonknight Dark Talons",
        types = {[1] = 32974}
    },
    -- sorcerer
    [TYPE_ATRONACH] = {
        id = "TYPE_ATRONACH",
        name = "Sorcerer Storm Atronach",
        types = {[1] = 48076}
    },
    [TYPE_LIGHTNING] = {
        id = "TYPE_LIGHTNING",
        name = "Sorcerer Lightning Splash",
        types = {[1] = 23196}
    },
    -- nightblade
    [TYPE_DARKNESS] = {
        id = "TYPE_DARKNESS",
        name = "Nightblade Consuming Darkness",
        types = {[1] = 37729}
    },
    [TYPE_SOUL] = {
        id = "TYPE_SOUL",
        name = "Nightblade Soul Shred",
        types = {[1] = 25170}
    },
    -- templar
    [TYPE_SHARD] = {
        id = "TYPE_SHARD",
        name = "Templar Spear Shard",
        types = {[1] = 26832, [2] = 95922}
    },
    [TYPE_NOVA] = {
        id = "TYPE_NOVA",
        name = "Templar Nova",
        types = {[1] = 31538, [2] = 31603}
    },
    [TYPE_RITUAL] = {
        id = "TYPE_RITUAL",
        name = "Templar Cleansing Ritual",
        types = {[1] = 26300}
    },
    -- warden
    [TYPE_SEED] = {
        id = "TYPE_SEED",
        name = "Warden Healing Seed",
        types = {[1] = 85577}
    },
    [TYPE_GATE] = {
        id = "TYPE_GATE",
        name = "Warden Frozen Retreat",
        types = {[1] = 88884}
    },
    -- necromancer
    [TYPE_GRAVE] = {
        id = "TYPE_GRAVE",
        name = "Necromancer Boneyard",
        types = {[1] = 115572}
    },
    [TYPE_TOTEM] = {
        id = "TYPE_TOTEM",
        name = "Necromancer Agony Totem",
        types = {[1] = 118618}
    },
    -- werewolf
    [TYPE_FRENZY] = {
        id = "TYPE_FRENZY",
        name = "Werewolf Howl of Despair",
        types = {[1] = 58775}
    }
}
...
for id, data in pairs(r.synids) do
    r.synids[id].name = string.lower(zo_strformat(SI_ABILITY_NAME,
                                                  GetAbilityName(id)))
...
function r.resourceTracker(e, _, _, powerType, powerValue, powerMax, _)
    if r.savedVars.enable then
        if not ((IsPlayerInAvAWorld() or IsActiveWorldBattleground()) and
            ...
            if ((powerType == POWERTYPE_MAGICKA) and r.savedVars.magBlock) or
                ((powerType == POWERTYPE_STAMINA) and r.savedVars.stamBlock) then
                if ((powerValue / powerMax) * 100 >= r.savedVars.magThreshold) or
                    ((powerValue / powerMax) * 100 >= r.savedVars.stamThreshold) then
                    r.blocking = true
                    return;
                end
            end
...
function r.blockSynergies()
    ZO_PreHook(SYNERGY, 'OnSynergyAbilityChanged', function(self)
        ...
        if name and icon then
            if r.debug then
                local link = ZO_LinkHandler_CreateLink(
                                 zo_strformat("<<C:1>>", name), nil,
                                 "synergydisplay", name, icon);
                d("|cf05a4f" .. link .. "|r");
                d(r.blocking)
            end
            for id, data in pairs(r.savedVars.synids) do
                if r.savedVars.synids[id].tex == icon and
                    r.savedVars.synids[id].blocked and r.blocking then
                    if r.debug then
                        d("Blocking '" .. name .. "'")
                    end
